                ...
                <div className="grid gap-4 pb-4 text-left lg:pb-0 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <Link href='https://www.facebook.com/profile.php?id=61563843784308' className="py-1 hover:underline">Facebook</Link>
                        </div>
                    </motion.div>
                </div>
            ...
            className="py-10 bg-black dark:bg-primary">
                <div className="container text-white text-center lg:justify-between lg:flex">
                    <div className="pb-4 lg:pb-0">
                        <p>&copy; 2024 Perks Group All Rights Reserved. [ Tech support from Myplate Inc. ]</p>
                    </div>
                    <div>
